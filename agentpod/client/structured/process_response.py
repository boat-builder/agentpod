...
def handle_response_model(
    ...
    if response_model is not None:
        ...
        if mode == Mode.FUNCTIONS:
            ...
            system_messages = [m["content"] for m in new_kwargs["messages"] if m["role"] == "system"]
            new_kwargs["system"] = "\n\n".join(system_messages)
            new_kwargs["messages"] = [m for m in new_kwargs["messages"] if m["role"] != "system"]
...
"""
            ...
            new_kwargs["contents"] = transform_to_gemini_prompt(new_kwargs.pop("messages"))
