...
from agentpod.tools.brave.exceptions import BraveError
...
from .faq import FAQ, QA, QAPage
from .location_result import LocationResult, Locations
...
class SearchResult(Result):
    ...
    deep_results: Optional[DeepResult] = Field(default=None, description="Gathered information on a web search result.")
    schemas: Optional[List] = Field(default=None, description="A list of schemas extracted from the web search result.")
